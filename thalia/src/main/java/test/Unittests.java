...
public class Unittests {
	...
	public void ticketReportTest()
	{
		...
		Show_Info si=new Show_Info("King Lear", 
								   "http://www.example.com/shows/king-lear",
								   "2017-12-05",
								   "13:00");
		
		ticketSalesSections tss1=new ticketSalesSections(123,
														"Front right",
														60,
														16,
														5,
														300);
		ticketSalesSections tss2=new ticketSalesSections(124,
														 "Front center",
														 75,
														 19,
														 1,
		...
		ticketSalesShow ts=new ticketSalesShow(308, si, tssArray);
		ArrayList <ticketSalesShow> tsArray=new ArrayList <ticketSalesShow>();
		tsArray.add(ts);
		
		ticketSalesReport tsr=new ticketSalesReport(802, 
		...
		Gson gson=new GsonBuilder().setPrettyPrinting().create();
		String st=gson.toJson(tsr);
		
		
		ArrayList <Seating_Info> seatArray=new ArrayList <Seating_Info>();
		Seating_Info seating1=new Seating_Info(123, 60);
		Seating_Info seating2=new Seating_Info(124, 75);
		Seating_Info seating3=new Seating_Info(125, 60);
		seatArray.add(seating1);
		seatArray.add(seating2);
		seatArray.add(seating3);
		Show s=new Show(308,si,seatArray);
		shows.put(308,s);
		...
		SimpleDateFormat sd=new SimpleDateFormat("yyyy-MM-dd HH:mm");
		String realStringDate=sd.format(d);
		int orderAmount1=180;
		int numberofTickets1=3;
		Patron_Info pi=new Patron_Info("John Doe", 
				   "123-456-7890",
				   "john.doe@example.com",
				   "123 Main ST, Anytown, IL 45678",
				   "1234567890987654",
				   "12/21");
		Order o1=new Order(411, 308, si, realStringDate, orderAmount1, numberofTickets1,pi);
		orders.put(411, o1);
		
		int orderAmount2=120;
		int numberofTickets2=2;
		Order o2=new Order(411, 308, si, realStringDate, orderAmount2, numberofTickets2,pi);
		orders.put(412, o2);
		
		int orderAmount3=75;
		int numberofTickets3=1;
		Order o3=new Order(411, 308, si, realStringDate, orderAmount3, numberofTickets3,pi);
		orders.put(413, o3);
		...
		//123 Front Right
				...
				ArrayList <service.Seating> arraySeating1=new ArrayList<service.Seating>();
				
				arraySeating1.add(firstSeat1);
				arraySeating1.add(secondSeat1);
				arraySeating1.add(thirdSeat1);
				arraySeating1.add(fourthSeat1);
				...
				//123
				ArrayList <Seats> arraySeats1=new ArrayList <Seats>();
				arraySeats1.add(seat1);
				arraySeats1.add(seat2);
				arraySeats1.add(seat3);
				arraySeats1.add(seat4);
				
				ArrayList <Seats> arraySeats2=new ArrayList <Seats>();
				arraySeats2.add(seat5);
				arraySeats2.add(seat6);
				arraySeats2.add(seat7);
				arraySeats2.add(seat8);
				
				ArrayList <Seats> arraySeats3=new ArrayList <Seats>();
				arraySeats3.add(seat9);
				arraySeats3.add(seat10);
				arraySeats3.add(seat11);
				arraySeats3.add(seat12);
				
				ArrayList <Seats> arraySeats4=new ArrayList <Seats>();
				arraySeats4.add(seat13);
				arraySeats4.add(seat14);
				arraySeats4.add(seat15);
				arraySeats4.add(seat16);
		...
		ticketSalesReport tr=rb.getTicketSalesReport(308);
