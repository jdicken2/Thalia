...
#f.close()"""
############
url1 = "http://localhost:8080/CS445Project/webapi/seating"
...
cmp2['sid'] = sid1
#url2 = join(url1,sid1)
url2= "http://localhost:8080/CS445Project/webapi/seating/123"
...
with open("cmp_files/out3.txt") as f:
    cmp3 = json.load(f)
f.close()
url3 = "http://localhost:8080/CS445Project/webapi/shows"
...
with open("cmp_files/out4.txt") as f:
    cmp4 = json.load(f)
f.close()
url4 = "http://localhost:8080/CS445Project/webapi/shows"
...
f.close()
cmp5[0]['wid'] = wid1
url5 = "http://localhost:8080/CS445Project/webapi/shows"
...
f.close()
cmp6['wid'] = wid1
#url6 = join("http://localhost:8080/CS445Project/webapi/shows",wid1)
url6 = "http://localhost:8080/CS445Project/webapi/shows/308"
...
with open("cmp_files/out7.txt") as f:
    cmp7 = f.read()
f.close()
#url7 = join("http://localhost:8080/CS445Project/webapi/shows",wid1)
url7 = "http://localhost:8080/CS445Project/webapi/shows/308"
...
f.close()
cmp8['wid']=wid1
#url8 = join("http://localhost:8080/CS445Project/webapi/shows",wid1)
url8 ="http://localhost:8080/CS445Project/webapi/shows/308"
...
for a in cmp9:
    ...
    if a['section_name'] == 'Front left':
       a['sid'] = sid3 
#url9 = "http://localhost:8080/CS445Project/webapi/shows/"+wid1+"/sections"
url9="http://localhost:8080/CS445Project/webapi/shows/308/sections"
...
cmp10['wid'] = wid1
cmp10['sid'] = sid1
#url10 = "http://localhost:8080/CS445Project/webapi/shows/"+wid1+"/sections/"+sid1
url10 = "http://localhost:8080/CS445Project/webapi/shows/308/sections/123"
...
#************************case 10 end****************************************************
#***************11.Request a number of contiguous seats that cannot be found in section sid1 ("Front right") ( GET /seating?show=wid1&section=sid1&count=5 ).*****
...
cmp11['starting_seat_id']=201
#url11 = "http://localhost:8080/CS445Project/webapi/seating?show="+wid1+"&section="+sid1+"&count=5"
url11 = "http://localhost:8080/CS445Project/webapi/seating?show=308&section=123&count=5"
...
for s_ in cmp12['seating'][0]['seats']:
    if s_['seat'] == '1':
        ...
        s_['cid'] = 204
#url12 = "http://localhost:8080/CS445Project/webapi/seating?show="+wid1+"&section="+sid1+"&count=4"
url12 = "http://localhost:8080/CS445Project/webapi/seating?show=308&section=123&count=4"
...
for s_ in cmp13['seating'][0]['seats']:
    if s_['seat'] == '2':
        ...
        s_['cid'] = 204
#url13 = "http://localhost:8080/CS445Project/webapi/seating?show="+wid1+"&section="+sid1+"&count=3"+"&starting_seat_id="+cid2
url13 = "http://localhost:8080/CS445Project/webapi/seating?show=308&section=123&count=3&starting_seat_id=202"
...
if  chk13:
    scores += 1
    print("13.Request a number of contigious seats starting with a specific seat in the section (GET /seating?show=%s&section=%s&count=3&starting_seat_id=%s): (pass)"%(wid1,sid1,202))
else:
    print("13.Request a number of contigious seats starting with a specific seat in the section (GET /seating?show=%s&section=%s&count=3&starting_seat_id=%s): (fail)"%(wid1,sid1,202))
#************************case 13 end****************************************************
...
for s_ in cmp14['seating'][0]['seats']:
    if s_['seat'] == '1':
        ...
        s_['cid'] = 216
#url14 = "http://localhost:8080/CS445Project/webapi/seating?show="+wid1+"&section="+sid1+"&count=4"+"&starting_seat_id="+cid2
url14 = "http://localhost:8080/CS445Project/webapi/seating?show=308&section=123&count=4&starting_seat_id=202"
...
if  chk14:
    scores += 1
    print("14.Test another request for contiguous seats starting with a specific seat ( GET /seating?show=%s&section=%s&count=4&starting_seat_id=%s ): (pass)"%(wid1,sid1,202))
else:
   print("14.Test another request for contiguous seats starting with a specific seat ( GET /seating?show=%s&section=%s&count=4&starting_seat_id=%s ) (fail)"%(wid1,sid1,202))
#************************case 14 end****************************************************
...
f.close()
cmp15['wid'] = wid1
url15 = "http://localhost:8080/CS445Project/webapi/orders"
...
url16 = "http://localhost:8080/CS445Project/webapi/orders"
...
#url17 = join("http://localhost:8080/CS445Project/webapi/orders",oid1)
url17 ="http://localhost:8080/CS445Project/webapi/orders/411"
...
f.close()
cmp18['wid'] = wid1
url18 = "http://localhost:8080/CS445Project/webapi/orders"
...
cmp19['wid'] = wid1
cmp19['sid'] = sid2
url19 = "http://localhost:8080/CS445Project/webapi/shows/308/sections/124"
...
cmp20['wid'] = wid1
data20 = {'data':json20}
url20 = "http://localhost:8080/CS445Project/webapi/orders"
...
for s_ in cmp21['seating'][1]['seats']:
    if s_['seat'] == '1':
        ...
        s_['cid'] = 208
url21 = "http://localhost:8080/CS445Project/webapi/shows/308/sections/123"
...
url22 = "http://localhost:8080/CS445Project/webapi/orders?start_date="+start_date+"&end_date="+end_date
...
f.close()
data23 = {'data':json23}
url23 = "http://localhost:8080/CS445Project/webapi/shows/308/donations"
...
f.close()
data24 = {'data':json24}
url24 = "http://localhost:8080/CS445Project/webapi/shows/308/donations"
...
cmp25['did'] = did1
cmp25['wid'] = wid1
url25 = "http://localhost:8080/CS445Project/webapi/shows/308/donations/759"
...
cmp26['did'] = did2
cmp26['wid'] = wid1
url26 = "http://localhost:8080/CS445Project/webapi/shows/308/donations/760"
...
f.close()
data27 = {'data':json27}
url27 = "http://localhost:8080/CS445Project/webapi/tickets/donations"
...
cmp28['wid'] = wid1
cmp28['tickets'] = [tid2]
url28 = "http://localhost:8080/CS445Project/webapi/shows/308/donations/759"
...
cmp29['wid'] = wid1
cmp29['tickets'] = [tid3]
url29 = "http://localhost:8080/CS445Project/webapi/shows/308/donations/760"
...
url30 ="http://localhost:8080/CS445Project/webapi/orders/411"
...
with open("cmp_files/out31.txt") as f:
    cmp31 = json.load(f)
f.close()
url31 = "http://localhost:8080/CS445Project/webapi/reports"
...
url32 = "http://localhost:8080/CS445Project/webapi/reports/802?show=308"
...
url33 = "http://localhost:8080/CS445Project/webapi/search?topic=order&key=411"
